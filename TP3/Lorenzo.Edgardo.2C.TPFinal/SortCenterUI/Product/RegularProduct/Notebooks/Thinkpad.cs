...
namespace EntidadesCore
{
    ...
    public class Thinkpad : Notebook
    {
        ...
        public override EScreenSize ScreenSize { get  { return base.screenSize; }  }
        public override int SsdModules { get { return base.ssdModules; } }
        public override int RamModules { get { return base.ramModules; } set { this.ramModules = value; } }
        public override int Battery { get { return base.battery; } }
        ...
        { 
            get { return this.hasDockingStation; } set { this.hasDockingStation = value; } 
        }
        [XmlIgnore]
