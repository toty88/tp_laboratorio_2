...
namespace Test
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //try
            //{
            //    query = SQL<Thinkpad>.BuildInsertQuery(properties, null);
            ...
            //            SQL<Thinkpad>.Insert(connectionString, query, properties, (Thinkpad)item);
            //        }
            //    }
            //}
            ...
            //type = type.Replace("EntidadesCore.", "");
            //Console.WriteLine($"p2 type: {type}");
            Console.ReadKey();
        }
